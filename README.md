...
### Controls
- Use **WASD** to move the gorilla across the screen
- Use **SPACEBAR** to interact with the banana or tree
- Use **ESC key** to exit the program.
- Use **M** to display the current coordinates of the mouse cursor

**DISCLAIMER: CODE FROM THE FOLLOWING DIRECTORIES HAVE BEEN PROVIDED VIA COURSEWORK AND I DO NOT CLAIM CREDIT FOR THE FOLLOWING:**
- /src/Data/gameString.java
- /src/Data/Sprite.java
- /src/logic
- /src/gameLoop
- /src/Input
- /src/FileIO
